...
class ViewController: UIViewController {
    ...
    func checkingAnswers()
    {
        ...
        else if  questLabel.text == question[1]
        {
        ...
        else if  questLabel.text == question[2]
        {
        ...
        else if  questLabel.text == question[3]
        {
        ...
        else if  questLabel.text == question[4]
        {
            if  thirdButton.backgroundColor == UIColor.brown
            {
                result += 10
       ...
       else if  questLabel.text == question[5]
        {
            if  firstButton.backgroundColor == UIColor.brown
            {
                result += 10
        ...
        else if  questLabel.text == question[6]
        {
            if  secondButton.backgroundColor == UIColor.brown
            {
                result += 10
        ...
        else if  questLabel.text == question[7]
        {
            if  secondButton.backgroundColor == UIColor.brown
            {
                result += 10
        ...
        else if  questLabel.text == question[8]
        {
            if  thirdButton.backgroundColor == UIColor.brown
            {
                result += 10
        ...
        else if  questLabel.text == question[9]
        {
            if  firstButton.backgroundColor == UIColor.brown
            {
                result += 10
